...
session_start();
 if(!isset($_SESSION['stuLogEmail'])) {
  ...
  <div class="container mt-5">
    ...
    <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_JMfMat96Nsu0L1" async> </script> </form><br>
    </div>
    <form method="post" action="./paymentdone.php">
     ...
     <small class="form-text text-muted"><a href="" style="text-decoration: none;"  onclick="return confirm_alert(this);">Note: Complete Payment by Clicking on Pay Now Button and Generate Invoice ID.</a></small>
     </div>
    </div>
  </div>
    ...
    function confirm_alert(node) {
        return confirm("Please complete the payment before proceeding.");
    }
    </script>
